...
export const SingleRecipePage = () => {
    ...
    const infoRecipe = useAppSelector((state) => state.recipes.infoRecipe);
        ...
        <>
            <div className="flex flex-col items-center pt-10 gap-10">
                <div className="m-auto">
                    <img className="w-full h-auto rounded-lg shadow-lg" src={infoRecipe.image} alt={infoRecipe.title} loading="lazy" />
                </div>
                <div className="text-lime-700">
                    ...
                    <div className="flex flex-col justify-around mt-12 md:flex-row md:space-y-0 md:space-x-4">
                        <p className="flex items-center">Vegan <img src={infoRecipe.vegan ? yeah : nope} alt="Vegan status" className="w-11" /></p>
                        <p className="flex items-center">Dairy Free <img src={infoRecipe.dairyFree ? yeah : nope} alt="Dairy Free status" className="w-11" /></p>
                        <p className="flex items-center">Gluten Free <img src={infoRecipe.glutenFree ? yeah : nope} alt="Gluten Free status" className="w-11" /></p>
                    </div>
                </div>
            </div>
